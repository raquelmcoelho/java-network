...
public class Config {
    ...
    public static final String IP_SERVER = "10.215.10.32";
    public static final String LOCAL_IP = getLocalIP();
    public static final String RMI_URL_BASE = "rmi://";
    public static final String RMI_SERVER = RMI_URL_BASE + IP_SERVER + "/";
    public static final String RMI_CLIENT = RMI_URL_BASE + LOCAL_IP + "/";
